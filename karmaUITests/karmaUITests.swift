...
final class karmaUITests: XCTestCase {
    ...
    func testRegistrationLogin() throws {
        ...
        app.buttons["select a photo"].tap()
        app.otherElements["Photos"].children(matching: .other).element.children(matching: .scrollView).element.tap()
